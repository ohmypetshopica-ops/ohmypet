        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="relative bg-gray-100 h-48">
                <img class="w-full h-full object-cover" 
                     ...
                     alt="${product.name}">
                ${product.discount ? `<span class="absolute top-2 left-2 bg-yellow-400 text-gray-900 text-xs font-bold px-2 py-1 rounded">-${product.discount}%</span>` : ''}
                ${product.is_new ? '<span class="absolute top-2 right-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">NUEVO</span>' : ''}
            ...
            <div class="p-4">
                ...
                <button class="add-to-cart-btn w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 text-sm font-bold py-2 px-4 rounded transition flex items-center justify-center gap-2" 
