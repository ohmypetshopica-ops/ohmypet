...
// ... (mantén las otras funciones como createClientRow, etc.) ...

// ===== FUNCIÓN createAppointmentRow (SIN BOTÓN "Fotos") =====
const createAppointmentRow = (appointment) => {
    ...
    if (status === 'pendiente') {
        ...
        // Para estados finales, no mostramos acciones. La info se ve en el perfil del cliente.
